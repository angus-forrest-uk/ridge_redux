...
## [0.5.2](https://github.com/angus-forrest-uk/ridge_redux/compare/ridge_redux-v0.5.1...ridge_redux-v0.5.2) - 2026-09-25

### Other

- untangle the canvas interaction paragraph after the revert
- Revert "fix(web): move drags grab the terrain, consistently on both surfaces"

## [0.5.1](https://github.com/angus-forrest-uk/ridge_redux/compare/ridge_redux-v0.5.0...ridge_redux-v0.5.1) - 2026-09-25

### Fixed

- *(web)* move drags grab the terrain, consistently on both surfaces

## [0.5.0](https://github.com/angus-forrest-uk/ridge_redux/compare/ridge_redux-v0.4.3...ridge_redux-v0.5.0) - 2026-09-24

### Added

- *(web)* move the area by dragging the rendered view, at frame rate

## [0.4.3](https://github.com/angus-forrest-uk/ridge_redux/compare/ridge_redux-v0.4.2...ridge_redux-v0.4.3) - 2026-09-24

### Added

- *(web)* shade loaded tiles green and fix the invisible latitude cutout
- *(api)* list the locally available tiles at GET /api/tiles
- *(web)* drag the selection to move it as-is
- *(api)* prefetch the tiles surrounding each view

## [0.4.2](https://github.com/angus-forrest-uk/ridge_redux/compare/ridge_redux-v0.4.1...ridge_redux-v0.4.2) - 2026-09-24

### Fixed

- announce a browsable URL when bound to a wildcard address

### Other

- recommend OrbStack alongside Docker Desktop on macOS
